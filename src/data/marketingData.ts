...
export const HERO_SLIDES = [
  {
    id: 1,
    tag: 'PREMIUM LIFE COACHING',
    title: '더 나은 삶으로 이어지는\n성장과 행복의 공간,\n라이프업과 함께하세요',
    subtitle: '혼자서만 끙끙 앓던 고민, 이제 끝내세요. 검증된 1:1 맞춤 AI 코칭과 매일 아침 카카오톡 모닝 케어로 당신의 잠재력을 깨워드립니다.',
    bgImage: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&w=1920&q=80',
    primaryCta: '3일 무료 체험 시작하기',
    secondaryCta: '프로그램 자세히 보기',
    highlightBadge: '누적 만족도 98.6% · 12,000명 돌파'
  },
  {
    id: 2,
    tag: 'DAILY MORNING CARE',
    title: '매일 아침 8시,\n당신의 하루를 깨우는\n1:1 카카오톡 맞춤 코칭',
    subtitle: '작은 습관이 모여 위대한 변화를 만듭니다. 매일 아침 나만을 위한 실천 미션과 마인드셋 케어를 휴대폰으로 받아보세요.',
    bgImage: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=1920&q=80',
    primaryCta: '카카오톡 모닝케어 신청',
    secondaryCta: '성공 후기 확인하기',
    highlightBadge: '첫 달 등록 시 모닝케어 100% 무료'
  },
  {
    id: 3,
    tag: 'THE MASTERS PROGRAM',
    title: '번아웃 극복부터 커리어 도약까지\n인생 2막을 여는\n마스터 솔루션',
    subtitle: '국내 최고 전문 라이프 코치진과 설계한 체계적 4주/8주 프로그램으로 방황하던 일상에 확실한 이정표를 세워드립니다.',
    ...
    secondaryCta: '수강료 및 혜택 보기',
    highlightBadge: '2025 상반기 신규 수강생 모집 중'
  }
];
...
export const NEWS_AND_NOTICES: NewsNoticeItem[] = [
  ...
  },
  {
    id: 'news-4',
    category: '공지사항',
    title: '3일 무료 체험 회원 대상 "웰컴 성장 진단 리포트" 발송 개시',
    summary: '무료 체험을 시작하신 모든 분들께 AI 정밀 멘탈 & 라이프 밸런스 분석 리포트를 무료로 제공합니다.',
    date: '2025.01.05',
    isNew: false
  }
];
